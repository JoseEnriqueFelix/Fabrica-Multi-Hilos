...
public class Linea {
    ...
    public Linea(ArrayList<Estacion> estaciones) {
    ...
    // if (i != estaciones.size() - 1 && estaciones.get(i + 1).isValido())
    // controlador.mandarCarro(auxNumCarro, numDeLinea, i);
    // }
    // }
    // }
}
...
// // controlador.actualizarVista(numDeLinea, i, auxRbt.getNumDeSerie(),
// // auxNumCarro);
// // dormir(estaciones[i].getTiempo());
// // System.out.println("Linea " + numDeLinea + ", numDeCarro " + auxNumCarro +
// ",
// // estacion "
...
// ",
// // estacion "
// // + estaciones[i].getNombre() + " caso especial" + ", robot " +
// // auxRbt.getNumDeSerie());
// // estaciones[i].getManejadorDeCola2().Espera();
